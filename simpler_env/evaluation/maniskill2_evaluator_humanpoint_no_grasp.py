...
def humanpoint_execution(images, env, obs, obs_camera_name, task_description, additional_env_build_kwargs, env_reset_options):
    ...
    # realpoint2arm = point2arm @ realpoint2point
    # realpoint2arm = pt.transform_from(gg.rotation_matrix, gg.translation) @ np.array([
    #     [ 1.33273491e-03, -4.43855639e-03,  9.99989261e-01, -1.63532970e-01 ],
    #     [ 8.68642486e-04, -9.99989767e-01, -4.43971631e-03,  1.88529490e-03 ],
    #     [ 9.99998735e-01,  8.74550123e-04, -1.32886575e-03, -4.33748960e-03 ],
