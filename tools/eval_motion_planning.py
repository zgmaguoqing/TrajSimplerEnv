...
def calc_pick_coke_can_stats(root_result_dir):
    ...
    base_variants = [
        "google_pick_coke_can_1_v4/arm_pd_joint_pos_gripper_pd_joint_pos/GraspSingleOpenedCokeCanInScene-v0_{}_True",
    ]
    ...
    background_variants = [
        "google_pick_coke_can_1_v4_alt_background/arm_pd_joint_pos_gripper_pd_joint_pos/GraspSingleOpenedCokeCanInScene-v0_{}_True",
        "google_pick_coke_can_1_v4_alt_background_2/arm_pd_joint_pos_gripper_pd_joint_pos/GraspSingleOpenedCokeCanInScene-v0_{}_True",
    ]
    lighting_variants = [
        "google_pick_coke_can_1_v4/arm_pd_joint_pos_gripper_pd_joint_pos/GraspSingleOpenedCokeCanInScene-v0_{}_True_slightly_brighter_lighting_True",
        "google_pick_coke_can_1_v4/arm_pd_joint_pos_gripper_pd_joint_pos/GraspSingleOpenedCokeCanInScene-v0_{}_True_slightly_darker_lighting_True",
    ]
    distractor_variants = [
        "google_pick_coke_can_1_v4/arm_pd_joint_pos_gripper_pd_joint_pos/GraspSingleOpenedCokeCanDistractorInScene-v0_{}_True",
        "google_pick_coke_can_1_v4/arm_pd_joint_pos_gripper_pd_joint_pos/GraspSingleOpenedCokeCanDistractorInScene-v0_{}_True_distractor_config_more",
    ]
    table_texture_variants = [
        "Baked_sc1_staging_objaverse_cabinet1_h870/arm_pd_joint_pos_gripper_pd_joint_pos/GraspSingleOpenedCokeCanInScene-v0_{}_True",
        "Baked_sc1_staging_objaverse_cabinet2_h870/arm_pd_joint_pos_gripper_pd_joint_pos/GraspSingleOpenedCokeCanInScene-v0_{}_True",
    ]
    # camera_variants = [
    #     'google_pick_coke_can_1_v4/arm_pd_joint_pos_gripper_pd_joint_pos/GraspSingleOpenedCokeCanAltGoogleCameraInScene-v0_{}_True',
    #     'google_pick_coke_can_1_v4/arm_pd_joint_pos_gripper_pd_joint_pos/GraspSingleOpenedCokeCanAltGoogleCamera2InScene-v0_{}_True',
...
def calc_move_near_stats(root_result_dir):
    ...
    # hardcoded variant aggregation result dirs; if you have new variants, please update here
    base_variants = [
        "google_pick_coke_can_1_v4/arm_pd_joint_pos_gripper_pd_joint_pos/MoveNearGoogleInScene-v0",
    ]
    base_visual_matching_variants = []
    for visual_matching_urdf_version in [
        "None",
        ...
        base_visual_matching_variants.append(
            f"google_pick_coke_can_1_v4/arm_pd_joint_pos_gripper_pd_joint_pos/MoveNearGoogleBakedTexInScene-v0_urdf_version_{visual_matching_urdf_version}_baked_except_bpb_orange"
        )

    background_variants = [
        "google_pick_coke_can_1_v4_alt_background/arm_pd_joint_pos_gripper_pd_joint_pos/MoveNearGoogleInScene-v0",
        "google_pick_coke_can_1_v4_alt_background_2/arm_pd_joint_pos_gripper_pd_joint_pos/MoveNearGoogleInScene-v0",
    ]
    lighting_variants = [
        "google_pick_coke_can_1_v4/arm_pd_joint_pos_gripper_pd_joint_pos/MoveNearGoogleInScene-v0_slightly_brighter_lighting_True",
        "google_pick_coke_can_1_v4/arm_pd_joint_pos_gripper_pd_joint_pos/MoveNearGoogleInScene-v0_slightly_darker_lighting_True",
    ]
    distractor_variants = [
        "google_pick_coke_can_1_v4/arm_pd_joint_pos_gripper_pd_joint_pos/MoveNearGoogleInScene-v0_no_distractor_True",
    ]
    table_texture_variants = [
        "Baked_sc1_staging_objaverse_cabinet1_h870/arm_pd_joint_pos_gripper_pd_joint_pos/MoveNearGoogleInScene-v0",
        "Baked_sc1_staging_objaverse_cabinet2_h870/arm_pd_joint_pos_gripper_pd_joint_pos/MoveNearGoogleInScene-v0",
    ]
    # camera_variants = [
    #     'google_pick_coke_can_1_v4/arm_pd_joint_pos_gripper_pd_joint_pos/MoveNearAltGoogleCameraInScene-v0',
    #     'google_pick_coke_can_1_v4/arm_pd_joint_pos_gripper_pd_joint_pos/MoveNearAltGoogleCamera2InScene-v0',
    # ] # we only consider camera variants when investigating the effect of different robustness factors on the same policy's performance
...
def calc_drawer_stats(root_result_dir):
    ...
    # hardcoded variant aggregation result dirs; if you have new variants, please update here
    base_variants = [
        "frl_apartment_stage_simple/arm_pd_joint_pos_gripper_pd_joint_pos/{}_shader_dir_rt",
    ]
    base_visual_matching_variants = []
    for visual_matching_urdf_version in [
        "None",
        ...
        base_visual_matching_variants.append(
            "dummy_drawer/arm_pd_joint_pos_gripper_pd_joint_pos/{}_shader_dir_rt_station_name_mk_station_recolor_light_mode_simple_disable_bad_material_True_"
            + urdf_version_str
        )

    background_variants = [
        "modern_bedroom_no_roof/arm_pd_joint_pos_gripper_pd_joint_pos/{}_shader_dir_rt",
        "modern_office_no_roof/arm_pd_joint_pos_gripper_pd_joint_pos/{}_shader_dir_rt",
    ]
    lighting_variants = [
        "frl_apartment_stage_simple/arm_pd_joint_pos_gripper_pd_joint_pos/{}_shader_dir_rt_light_mode_brighter",
        "frl_apartment_stage_simple/arm_pd_joint_pos_gripper_pd_joint_pos/{}_shader_dir_rt_light_mode_darker",
    ]
    table_texture_variants = [
        "frl_apartment_stage_simple/arm_pd_joint_pos_gripper_pd_joint_pos/{}_shader_dir_rt_station_name_mk_station2",
        "frl_apartment_stage_simple/arm_pd_joint_pos_gripper_pd_joint_pos/{}_shader_dir_rt_station_name_mk_station3",
    ]
